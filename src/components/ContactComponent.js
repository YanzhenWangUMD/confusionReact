...
import {BreadcrumbItem, Breadcrumb, Form, Label, Button, FormGroup, Input, Col, Row, FormFeedback} from 'reactstrap';
                        ...
                        <Form onSubmit={this.handleSummit}>
                            ...
                            <FormGroup row>
                                ...
                                <Col md={{size: 10, offset: 2}}>
                                    <Button type="summit" color="primary">Send Feedback</Button>
                                </Col>
                            </FormGroup>
                        </Form>
                    </div>
