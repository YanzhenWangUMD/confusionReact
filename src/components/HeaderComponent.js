...
import { Nav, Navbar, NavbarBrand, NavbarToggler, Collapse, NavItem, Jumbotron,Modal,Button,ModalBody, ModalHeader,
...
class Header extends Component{
    ...
    handleLogin(event){
        this.toggleModal();
        alert("Username: "+ this.username.value + " Password: " + this.password.value + " Remember: " + this.remember.check);
    ...
    render(){
        ...
        <React.Fragment>
            ...
            <Modal isOpen ={this.state.isModalOpen} toggle={this.toggeModal}>
                <ModalHeader toggle={this.toggeModal}>Login</ModalHeader>
                <ModalBody>
